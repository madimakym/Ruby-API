...
class EvenementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evenement" do
    assert_difference('Evenement.count') do
      post evenements_url, params: { evenement: { date: @evenement.date, description: @evenement.description, heure: @evenement.heure, image: @evenement.image, libelle: @evenement.libelle } }
    end
  ...
  test "should update evenement" do
    patch evenement_url(@evenement), params: { evenement: { date: @evenement.date, description: @evenement.description, heure: @evenement.heure, image: @evenement.image, libelle: @evenement.libelle } }
